...
declare -A time=(
  ...
  # ["guanaco-7B-HF"]="??:??:??"
    ["guanaco-7B-HF"]="06:00:00"
  # ["guanaco-13B-HF"]="??:??:??"
    ["guanaco-13B-HF"]="06:00:00"
  # ["koala-7B-HF"]="??:??:??"
  ...
  # ["mpt-7b-chat"]="??:??:??"
    ["mpt-7b-chat"]="06:00:00"
  # ["openchat_3.5"]="??:??:??"
    ["openchat_3.5"]="06:00:00"
...
for model in "${!time[@]}"; do
    for dataset in "behaviour" "unseen" "cona" "controversial" "malicious" "qharm"; do
        submit_seed "${time[${model}]}" "$(job_script)" \
            python3 experiments/jailbreak.py \
